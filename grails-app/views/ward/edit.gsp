...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                <input type="hidden" name="id" value="${wardInstance?.id}" />
                <input type="hidden" name="version" value="${wardInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:wardInstance,field:'people','errors')}">
                                    <g:select name="people"
from="${com.atomyk.wardcoop.Person.list()}"
size="5" multiple="yes" optionKey="id"
value="${wardInstance?.people}" />
